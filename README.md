...
# euvat-performance-tests

Performance test suite for the `<EUVAT>`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
...
Start `EUVAT Performance Tests` services as follows:

...
trait NewClaimSimulation {
  ...
  setup("claim-details-germany", "Claim details for Germany") withRequests (ClaimDetailsRequests.AddClaimDetailsJourneyForGermany: _*)
  setup("purchase-details-germany", "Purchase details for Germany") withRequests (PurchaseRequests.AddPurchaseJourneyForGermany: _*)
